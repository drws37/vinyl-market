...
export const recordUpdate = createAsyncThunk(
  'records/update',
  (obj: { id: RecordId | undefined; obj: FormData }) => api.fetchRecordUpdate(obj),
);
export const recordRemove = createAsyncThunk('records/remove', (id: RecordId | undefined) =>
...
const recordsSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(recordAdd.fulfilled, (state, action) => {
        state.records.unshift(action.payload);
      })
      .addCase(recordAdd.rejected, (state, action) => {
        state.message = action.error.message;
      })
      ...
      .addCase(recordUpdate.rejected, (state, action) => {
        state.message = action.error.message;
      })
