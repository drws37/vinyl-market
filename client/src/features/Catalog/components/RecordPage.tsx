  ...
  return (
    <div>
      ...
      <form className='update__form' onSubmit={updateRecordFetch}>
            <input defaultValue={currentRecord?.title} value={title} placeholder='title' required onChange={(e)=>setTitle(e.target.value)} />
            <input defaultValue={currentRecord?.artist} value={artist} placeholder='artist' onChange={(e)=>setArtist(e.target.value)}/>
            <input defaultValue={currentRecord?.description} value={description} placeholder='description' onChange={(e)=>setDescription(e.target.value)}/>
            <input defaultValue={currentRecord?.price} value={price} placeholder='price' onChange={(e)=>setPrice(e.target.value)}/>
            <input  placeholder='img' type='file' onChange={(e)=>setImg(e.target.files)}/>
            <select defaultValue={currentRecord?.quality} value={quality} onChange={(e) => setQuality(e.target.value)}>
