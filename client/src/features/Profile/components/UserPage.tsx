...

{
   user?.role === 'seller' ? 
   <>
   <button onClick={() => setAddstate((prev) => !prev)} type='submit'> Заполнить данные о магазине</button>
   <button onClick={() => setUpdatestate((prev) => !prev)} type='submit'> Изменить данные о магазине</button>
